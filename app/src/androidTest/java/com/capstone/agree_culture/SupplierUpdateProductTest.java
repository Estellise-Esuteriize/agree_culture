...
public class SupplierUpdateProductTest {

    @Rule
    public ActivityTestRule<MainActivity> mActivityTestRule = new ActivityTestRule<>(MainActivity.class);

    @Test
    public void supplierUpdateProductTest() {
        ...
        ViewInteraction recyclerView = onView(
                allOf(withId(R.id.menu_products_list),
                        childAtPosition(
        ...
        ViewInteraction textInputEditText = onView(
                allOf(withId(R.id.product_create_name), withText("Prodtest"),
                        childAtPosition(
                                childAtPosition(
                                        withClassName(is("android.support.design.widget.TextInputLayout")),
                                        0),
                                0),
                        isDisplayed()));
        textInputEditText.perform(replaceText("Prodtesttt"));

        ViewInteraction textInputEditText2 = onView(
                allOf(withId(R.id.product_create_name), withText("Prodtesttt"),
                        childAtPosition(
                                childAtPosition(
                                        withClassName(is("android.support.design.widget.TextInputLayout")),
                                        0),
        ...
        ViewInteraction appCompatButton2 = onView(
                allOf(withId(R.id.product_update_btn), withText("Update"),
                        childAtPosition(
                                childAtPosition(
